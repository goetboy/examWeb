<template>
    <div class="main">
        ...
        <el-dialog :visible.sync="page.menuAddFormData.showDialog" close-on-click-modal open="open"
                   ...
                   @closed="closeDialog(page.menuAddFormData)">
            <menu-add-form @close-dialog="closeDialog(page.menuAddFormData)" ref="addFormDialog"
        ...
        <el-dialog :visible.sync="page.menuUpdateFormData.showDialog" close-on-click-modal open="open"
                   ...
                   @closed="closeDialog(page.menuUpdateFormData)">
            <menu-update-form :menu="page.selected" ref="updateFormDialog"
                              @close-dialog="closeDialog(page.menuUpdateFormData)"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //显示权限选择框
            showMenuRoutersTrans() {
                if (!this.page.selected) {
                    this.$message.error("请选择一个菜单")
                    return;
                }
                this.page.menuRoutersData.showDialog = true;
