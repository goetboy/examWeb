  ...
  <el-form :rules="userRoules" ref="login"  :model="login" class="from">
    <div>
      ...
      <el-form-item  label="确认密码" prop="password">
        <el-input  type="password" v-model="login.password2" placeholder="请输入密码" />
      </el-form-item>
    </div>
    <el-form-item>
      <!-- 按钮 类型  单击事件 键盘事件 -->
      <el-button type="primary" v-on:click="loSubmit('login')"  @keydown.enter="loSubmit('login')"  >注册</el-button><span >已有账号？
